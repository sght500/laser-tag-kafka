from kafka_messaging27 import KafkaMessenger, KafkaMessageHandler, KafkaMapReader
import string
import pygame
import random
import time
...
TIME_TO_GET_MAP = 76  # Seconds to get a Map or create it.
    ...
    if game_state == GAME_MENU:
        ...
        if got_a_map:
            ...
            if menu_elapsed >= TIME_TO_GET_MAP:
                got_a_map = True
                print(f"Last activity was {map_reader.last_activity_age:.3f}s ago.")
                if reuse_map:
                    print("✅ Reusing maze from Kafka topic.")

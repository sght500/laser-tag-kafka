from kafka_messaging29 import KafkaMessenger, KafkaMessageHandler
import string
import pygame
import random
import time
...
TIME_TO_GET_MAP = 3  # Number of seconds without map to generate a new map.
    ...
    if game_state == GAME_MENU:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                running = False
            elif event.type == player_timer and map:
                messenger.send_waiting_2_join(map)

from kafka_messaging13 import KafkaMessenger, KafkaMessageHandler, KafkaMapManager
import string
import pygame
import random
import time
...
MAX_AGE_LAST_ACTIVITY = 120  # Seconds from last activity to create a new maze.

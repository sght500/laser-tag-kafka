...
BG_COLOR = (30, 30, 30)
BG_COLOR_ALPHA = (30, 30, 30, 229)  # Alpha 90% (10% Transparent)
...
ENEMY_TIMERS = [300,350,500,55,65]  # How often the local enemies shoot.
...
class Player:
    ...
    def draw(self, screen):
        ...
        pygame.draw.rect(player_surface, self.color, (0, 0, self.rect.width, self.rect.height))
        ...
        player_surface.fill((0, 0, 0, 0), cutout_rect)
...
def handle_kafka_message(sender_id, data):
    ...
    if msg_type == "wasd-update":
        ...
        try:
            remote_enemies.pop(sender_id)  # Add ", None" if finding too many KeyError exceptions.
        except Exception as e:
            print(f"Unable to remove remote_enemy {sender_id}. Reason: {e}")
...
# Darken background with a transparent black overlay

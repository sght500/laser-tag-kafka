from kafka_messaging03 import KafkaMessenger, KafkaMessageHandler, KafkaMapManager
import string
import pygame
import random
import time
...
# Maze Class
class Maze:
    def __init__(self, rows, cols, pixels, map=None):
        self.pixels = pixels
        self.bricks = []
...
map_manager = KafkaMapManager(bootstrap_servers=BOOTSTRAP_SERVERS)

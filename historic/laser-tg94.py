...
# Watching Mode
font_big = pygame.font.Font('font/Fontdiner_Swanky/FontdinerSwanky-Regular.ttf', 48)
font_small = pygame.font.Font('font/Fontdiner_Swanky/FontdinerSwanky-Regular.ttf', 36)

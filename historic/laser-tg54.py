from kafka_messaging22 import KafkaMessenger, KafkaMessageHandler, KafkaMapReader
import string
import pygame
import random
import time
...
def handle_kafka_message(sender_id, data, current_keys):
    ...
    if msg_type == "wasd-update":
        ...
        if sender_id in remote_enemies:
            ...
            print (f"Created {sender_id} remote enemy on WASD update message. DEPRECATE THIS!")

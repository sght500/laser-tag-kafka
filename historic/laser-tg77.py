...
TIME_TO_GET_MAP = 6  # Seconds to get a Map or create it.
    ...
    if game_state == GAME_MENU:
        ...
        if got_a_map:
            ...
            if map_reader.map:
                if map_reader.last_activity_age:
                    print(f"last_activity_age {map_reader.last_activity_age:.3f}")
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                print("sent waiting to join {:.2f}".format(time.time()))
